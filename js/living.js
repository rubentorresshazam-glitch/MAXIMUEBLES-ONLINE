document.addEventListener('DOMContentLoaded', async () => {
  ...
  // ✅ DIBUJA LAS TARJETAS — CON IMAGEN DE REEMPLAZO
  productos.forEach(prod => {
    ...
    // ✅ Si tiene imagen → la muestra; si NO → cuadro gris con el nombre
    if (tieneImagen) {
      ...
      // ✅ SIN imagen → cuadro de color con el nombre
      tarjeta.innerHTML = `
        <a href="/producto-detalles.html?id=${prod.id}" class="enlace-producto">
